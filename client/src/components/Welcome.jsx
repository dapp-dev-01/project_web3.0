...
import { FileIpfs, JsonIpfs, Loader } from ".";
...
const Welcome = () => {
  ...
  const handleSubmit = (e) => {
    var { addressTo, amount, keyword, message, imageUrl } = formData;

    //override the form value
    ...
    sendTransaction(addressTo, amount, keyword, message, imageUrl);
  };
      ...
      <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
        ...
        <div className="flex flex-col flex-1 items-center justify-start w-full mf:mt-0 mt-10">
          ...
          <div className="p-5 sm:w-96 w-full flex flex-col justify-start items-center blue-glassmorphism">
            ...
            <Input placeholder="Image URL" name="imageUrl" type="hidden" handleChange={handleChange} />
              <FileIpfs/>
